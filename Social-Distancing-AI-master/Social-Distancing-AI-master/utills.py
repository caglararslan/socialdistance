...
# Tüm sınırlayıcı kutular için alt merkezi hesaplama ve tüm noktalar için perspektifi dönüştürme işlevi.
...
#  tüm çiftler arasındaki mesafeyi ve yakınlık oranını hesaplamak.
...
# kuş bakışının ölçeğini veren fonsksiyon             
def get_scale(W, H):
...
# insanların risk durumunu hesaplayan fonksiyon
